...
<SingleProduct :user='this.id'></SingleProduct>
<Footer></Footer>
</div>
</template>
...
export default {
    ...
    methods: {
        postData(event) {
            ...
            // }
            // // var numberFormat='/(7|8|9)\d{9}/'
            // // if(!this.posts.mobileNumber.includes(numberFormat)){
...
<div>
<div class="header-component">
    <span class="logo"><img src="../assets/logo.jpg" alt="" class="logo-image"></span>
    <div class="header-nav">
      <router-link to="/mlogin" class="a-link">Merchant</router-link>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <router-link to="/cart" class="a-link">Cart</router-link>&nbsp;&nbsp;&nbsp;
    </div>
